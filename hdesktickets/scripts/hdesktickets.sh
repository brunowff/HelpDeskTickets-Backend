...
export HDT_JAR
export HDT_API_TOKEN_ACCESS_EXPIRATION
export HDT_API_TOKEN_REFRESH_EXPIRATION
...
echo "HDT_API_TOKEN_ACCESS_EXPIRATION="$HDT_API_TOKEN_ACCESS_EXPIRATION
echo "HDT_API_TOKEN_REFRESH_EXPIRATION="$HDT_API_TOKEN_REFRESH_EXPIRATION
...
java -DHDT_API_PROFILE=$HDT_API_PROFILE \
    ...
    -DHDT_PORT=$HDT_PORT \
    -DHDT_API_TOKEN_ACCESS_EXPIRATION=$HDT_API_TOKEN_ACCESS_EXPIRATION \
    -DHDT_API_TOKEN_REFRESH_EXPIRATION=$HDT_API_TOKEN_REFRESH_EXPIRATION \
    -jar $HDT_JAR;
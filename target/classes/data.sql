...
INSERT INTO tb_roles (role_id, name) VALUES (11, 'API_TICKET_CATEGORY') ON CONFLICT (role_id) DO NOTHING;
INSERT INTO tb_roles (role_id, name) VALUES (12, 'API_TICKET_CATEGORY_MANAGER') ON CONFLICT (role_id) DO NOTHING;
